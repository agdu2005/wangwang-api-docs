...
> 📅 更新时间：2026-08-18  
> 🐶 旺旺 Hermes Agent — 当前活跃 MCP 一览

---

## 1. research-assistant

**说明：** 学术研究助手 MCP，支持论文检索、文献分析、统计分析、报告生成。

**传输方式：** stdio → /opt/research-assistant/.venv/bin/python  
**工具数量：** 15
...
| search_papers | 检索论文：优先语义检索（需先 index_and_search 建立索引），索引为空时自动回退多源并行了搜索 |
...
| update_journal_database | 从 CrossRef API 批量更新本地期刊数据库。按期刊名放入 queries 参数，按 ISSN 放入 issns 参数 |

---

> 🐶 旺旺 Hermes Agent 提供技术支持
