...
> 更新时间：2026-08-16（北京时间 08:00）

## 概览

| MCP 服务 | 状态 | 工具数 |
|---------|------|-------|
| research-assistant | ✅ Connected | 15 |
...
**功能描述：** 多源文献检索、统计分析、论文报告生成、期刊格式管理，覆盖学术研究全流程。
...
| `update_journal_database` | 从 CrossRef API 批量更新本地期刊数据库，按期刊名或 ISSN 批量查询 |
