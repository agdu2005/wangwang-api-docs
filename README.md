...
学术研究辅助 MCP，支持论文检索、统计分析、报告生成、期刊格式化等功能。
...
| `fetch_journal_online` | 从 CrossRef API 实时查询期刊规格（无需本地数据库），支持任意期刊 |
| `update_journal_database` | 从 CrossRef API 批量更新本地期刊数据库 |

---

*文档由 Hermes Agent 自动生成 · 更新日期: 2026-08-13*
